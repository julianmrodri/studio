...
import type { StakedRsr, StakedRsrInterface } from '../StakedRsr';
    ...
    outputs: [
      {
        ...
        internalType: 'struct StRSRP1Votes.Checkpoint',
        name: '',
        type: 'tuple',
      },
    ],
...
export class StakedRsr__factory {
  static readonly abi = _abi;
  static createInterface(): StakedRsrInterface {
    return new utils.Interface(_abi) as StakedRsrInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): StakedRsr {
    return new Contract(address, _abi, signerOrProvider) as StakedRsr;
  }
}
